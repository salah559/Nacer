      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "5vh 7vw" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5vw" }}>
          <div className="anim-morph-in delay-4 card-clean" style={{ display: "flex", gap: "1.2vw", alignItems: "center", padding: "1.6vh 1.5vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(201,168,76,0.10)", border: "1px solid rgba(201,168,76,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5vw", flexShrink: 0 }}>💼</div>
            <div>
              <div style={{ fontSize: "1.3vw", fontWeight: 700, color: "#1a1a2e" }}>التنويع الاقتصادي</div>
              <div style={{ fontSize: "1.05vw", color: "#5a5a7a" }}>تقليص الاعتماد على المحروقات</div>
            </div>
          </div>
          <div className="anim-morph-in delay-5 card-clean" style={{ display: "flex", gap: "1.2vw", alignItems: "center", padding: "1.6vh 1.5vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(201,168,76,0.10)", border: "1px solid rgba(201,168,76,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5vw", flexShrink: 0 }}>🎓</div>
            <div>
              <div style={{ fontSize: "1.3vw", fontWeight: 700, color: "#1a1a2e" }}>استيعاب الشباب</div>
              <div style={{ fontSize: "1.05vw", color: "#5a5a7a" }}>احتضان فئة حاملي الشهادات</div>
            </div>
          </div>
          <div className="anim-morph-in delay-6 card-clean" style={{ display: "flex", gap: "1.2vw", alignItems: "center", padding: "1.6vh 1.5vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(201,168,76,0.10)", border: "1px solid rgba(201,168,76,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5vw", flexShrink: 0 }}>🏗️</div>
            <div>
              <div style={{ fontSize: "1.3vw", fontWeight: 700, color: "#1a1a2e" }}>تنمية المناطق</div>
              <div style={{ fontSize: "1.05vw", color: "#5a5a7a" }}>التوزيع الإقليمي للنشاط</div>
            </div>
          </div>
          <div className="anim-morph-in delay-7 card-clean" style={{ display: "flex", gap: "1.2vw", alignItems: "center", padding: "1.6vh 1.5vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(201,168,76,0.10)", border: "1px solid rgba(201,168,76,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.5vw", flexShrink: 0 }}>⚡</div>
            <div>
              <div style={{ fontSize: "1.3vw", fontWeight: 700, color: "#1a1a2e" }}>الابتكار والتكيّف</div>
              <div style={{ fontSize: "1.05vw", color: "#5a5a7a" }}>مرونة أعلى من الشركات الكبرى</div>
            </div>
          </div>
        </div>
      </div>
