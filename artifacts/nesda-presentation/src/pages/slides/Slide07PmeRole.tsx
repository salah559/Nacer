    ...
    <div className={`relative w-screen h-screen overflow-hidden ${cls}`} style={{ background: "#ffffff", fontFamily: "Cairo, sans-serif", direction: "rtl" }}>
      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "5vh 7vw" }}>
        <div style={{ marginBottom: "2.5vh" }}>
          <div className="anim-smooth-fade delay-1" style={{ fontSize: "1.59vw", color: "#DAA520", letterSpacing: "0.18em", fontWeight: 700, marginBottom: "0.6vh" }}>الفصل الأول</div>
          <h2 className="anim-title-rtl delay-2" style={{ fontSize: "4.25vw", fontWeight: 900, color: "#1a1a2e", margin: 0, lineHeight: 1.2 }}>دور PME في الاقتصاد الوطني</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: "1.5vw", marginBottom: "2vh" }}>
          <div className="anim-count-morph delay-3 card-clean" style={{ textAlign: "center", position: "relative", overflow: "hidden", padding: "1.8vh 1vw" }}>
            ...
            <div style={{ fontSize: "4vw", fontWeight: 900, color: "#DAA520", lineHeight: 1 }}>97%</div>
          ...
          <div className="anim-count-morph delay-4 card-clean" style={{ textAlign: "center", position: "relative", overflow: "hidden", padding: "1.8vh 1vw" }}>
            <div className="gold-line" style={{ position: "absolute", top: 0, left: "20%", right: "20%" }} />
            <div style={{ fontSize: "4vw", fontWeight: 900, color: "#DAA520", lineHeight: 1 }}>60%</div>
          ...
          <div className="anim-count-morph delay-5 card-clean" style={{ textAlign: "center", position: "relative", overflow: "hidden", padding: "1.8vh 1vw" }}>
            <div className="gold-line" style={{ position: "absolute", top: 0, left: "20%", right: "20%" }} />
            <div style={{ fontSize: "4vw", fontWeight: 900, color: "#DAA520", lineHeight: 1 }}>30%</div>
          ...
          <div className="anim-count-morph delay-6 card-active" style={{ textAlign: "center", position: "relative", overflow: "hidden", padding: "1.8vh 1vw" }}>
            <div className="gold-line" style={{ position: "absolute", top: 0, left: "20%", right: "20%" }} />
            <div style={{ fontSize: "4vw", fontWeight: 900, color: "#DAA520", lineHeight: 1 }}>1.2M</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5vw" }}>
          <div className="anim-morph-in delay-4 card-clean" style={{ display: "flex", gap: "1.2vw", alignItems: "center", padding: "1.6vh 1.5vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(201,168,76,0.10)", border: "1px solid rgba(201,168,76,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "2.1vw", flexShrink: 0 }}>💼</div>
            <div>
          ...
          <div className="anim-morph-in delay-6 card-clean" style={{ display: "flex", gap: "1.2vw", alignItems: "center", padding: "1.6vh 1.5vw" }}>
            <div style={{ width: "3vw", height: "3vw", borderRadius: "50%", background: "rgba(201,168,76,0.10)", border: "1px solid rgba(201,168,76,0.2)", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "2.1vw", flexShrink: 0 }}>🏗️</div>
            <div>
