...
export default function Slide16FieldResults() {
  return (
    <div className={`relative w-screen h-screen overflow-hidden ${cls}`} style={{ background: "#050a18", fontFamily: "Cairo, sans-serif", direction: "rtl" }}>
      <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 80% 60% at 50% 35%, rgba(10,20,50,0.9) 0%, transparent 70%)" }} />
      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "6vh 8vw" }}>
        <div style={{ marginBottom: "3vh" }}>
          ...
          <h2 className="anim-clip-rtl delay-2" style={{ fontSize: "4vw", fontWeight: 900, color: "#f0f4ff", margin: 0 }}>نتائج الدراسة الميدانية</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: "2vw", marginBottom: "2.5vh" }}>
          <div className="anim-counter delay-3" style={{ background: "rgba(14,22,44,0.65)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "1.2vw", padding: "2vh 1vw", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ fontSize: "1.1vw", color: "#f0f4ff", marginTop: "0.5vh", lineHeight: 1.3 }}>نسبة القبول والتمويل</div>
          </div>
          <div className="anim-counter delay-4" style={{ background: "rgba(14,22,44,0.65)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "1.2vw", padding: "2vh 1vw", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ fontSize: "1.1vw", color: "#f0f4ff", marginTop: "0.5vh", lineHeight: 1.3 }}>التمويل الثلاثي هو الأكثر شيوعاً</div>
          </div>
          <div className="anim-counter delay-5" style={{ background: "rgba(201,168,76,0.09)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(201,168,76,0.35)", borderRadius: "1.2vw", padding: "2vh 1vw", textAlign: "center", position: "relative", overflow: "hidden", boxShadow: "0 0 2vw rgba(201,168,76,0.1)" }}>
            ...
            <div style={{ fontSize: "1.1vw", color: "#f0f4ff", marginTop: "0.5vh", lineHeight: 1.3 }}>منصب شغل بالمشروع الواحد</div>
          </div>
          <div className="anim-counter delay-6" style={{ background: "rgba(14,22,44,0.65)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(201,168,76,0.2)", borderRadius: "1.2vw", padding: "2vh 1vw", textAlign: "center", position: "relative", overflow: "hidden" }}>
            ...
            <div style={{ fontSize: "1.1vw", color: "#f0f4ff", marginTop: "0.5vh", lineHeight: 1.3 }}>المشاريع لا تزال نشطة</div>
          </div>
        </div>

        {/* Challenges */}
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2vw" }}>
          <div className="anim-fade-up delay-5" style={{ background: "rgba(14,22,44,0.5)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.12)", borderRadius: "1vw", padding: "2vh 2.5vw" }}>
            ...
            <div style={{ display: "flex", gap: "0.8vw", flexWrap: "wrap" }}>
              <div style={{ background: "rgba(201,168,76,0.1)", borderRadius: "0.5vw", padding: "0.5vh 1vw", fontSize: "1.3vw", color: "#f0f4ff" }}>الخدمات</div>
              <div style={{ background: "rgba(201,168,76,0.1)", borderRadius: "0.5vw", padding: "0.5vh 1vw", fontSize: "1.3vw", color: "#f0f4ff" }}>الصناعة الخفيفة</div>
              <div style={{ background: "rgba(201,168,76,0.1)", borderRadius: "0.5vw", padding: "0.5vh 1vw", fontSize: "1.3vw", color: "#f0f4ff" }}>البناء</div>
              <div style={{ background: "rgba(201,168,76,0.1)", borderRadius: "0.5vw", padding: "0.5vh 1vw", fontSize: "1.3vw", color: "#f0f4ff" }}>التجارة</div>
            </div>
          </div>
          <div className="anim-fade-up delay-6" style={{ background: "rgba(14,22,44,0.5)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.12)", borderRadius: "1vw", padding: "2vh 2.5vw" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.6vh" }}>
              <div style={{ fontSize: "1.3vw", color: "#f0f4ff" }}>• صعوبة متابعة المشاريع بعد الإطلاق</div>
              <div style={{ fontSize: "1.3vw", color: "#f0f4ff" }}>• ضعف التنسيق مع القطاع البنكي أحياناً</div>
              <div style={{ fontSize: "1.3vw", color: "#f0f4ff" }}>• ضرورة تعزيز التكوين المتخصص</div>
            </div>
          </div>
        </div>
      </div>
