...
export default function Slide05RoadmapCh1() {
  return (
    <div className={`relative w-screen h-screen overflow-hidden ${cls}`} style={{ background: "#ffffff", fontFamily: "Cairo, sans-serif", direction: "rtl" }}>
      ...
      <div className="particle particle-1" style={{ top: "10%", right: "20%", width: "0.4vw", height: "0.4vw", background: "rgba(201,168,76,0.4)", boxShadow: "0 0 1vw rgba(201,168,76,0.5)" }} />
      <div className="particle particle-4" style={{ top: "68%", right: "30%", width: "0.3vw", height: "0.3vw", background: "rgba(201,168,76,0.3)" }} />
      ...
      <div className="relative z-10 flex h-full">
        ...
        <div style={{ width: "36%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "7vh 3vw 7vh 7vw", borderLeft: "1px solid rgba(201,168,76,0.15)" }}>
          ...
          <h2 className="anim-clip-rtl delay-3" style={{ fontSize: "3.6vw", fontWeight: 900, margin: 0, lineHeight: 1.15 }}>
            <span className="gold-shimmer" style={{ display: "inline-block" }}>الفصل الأول</span>
          </h2>
