        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "2.5vw", flex: 1, alignItems: "center" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.8vh" }}>
            <div className="anim-card-morph delay-3" style={{ background: "rgba(240,244,252,0.92)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: "1.2vw", padding: "2vh 2.5vw", position: "relative", overflow: "hidden", boxShadow: "0 0 3vw rgba(201,168,76,0.06), inset 0 1px 0 rgba(201,168,76,0.28)" }}>
              ...
              <div style={{ fontSize: "1.89vw", color: "#DAA520", fontWeight: 700, marginBottom: "1.2vh" }}>معيار القانون الجزائري 18-01</div>
              <div style={{ display: "flex", gap: "2vw" }}>
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontSize: "4vw", fontWeight: 900, color: "#DAA520", lineHeight: 1 }}>{"< 250"}</div>
                ...
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontSize: "4vw", fontWeight: 900, color: "#DAA520", lineHeight: 1 }}>4مـ</div>
                  <div style={{ fontSize: "1.74vw", color: "#4a5a78", marginTop: "0.3vh" }}>رقم الأعمال</div>
                </div>
                <div style={{ width: "0.15vh", background: "rgba(201,168,76,0.2)", alignSelf: "stretch" }} />
                <div style={{ textAlign: "center" }}>
                  <div style={{ fontSize: "4vw", fontWeight: 900, color: "#DAA520", lineHeight: 1 }}>1مـ</div>
            ...
            <div className="anim-card-morph delay-4" style={{ background: "rgba(240,244,252,0.80)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "1vw", padding: "1.8vh 2.5vw" }}>
              <div style={{ fontSize: "1.89vw", color: "#DAA520", fontWeight: 700, marginBottom: "0.8vh" }}>التصنيف الثلاثي</div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.8vh" }}>
            <div className="anim-morph-in delay-4" style={{ background: "rgba(201,168,76,0.07)", backdropFilter: "blur(16px)", WebkitBackdropFilter: "blur(16px)", border: "1px solid rgba(201,168,76,0.3)", borderRadius: "1.5vw", padding: "2.5vh 2vw", textAlign: "center", boxShadow: "0 0 3vw rgba(201,168,76,0.28)" }}>
              ...
              <div style={{ fontSize: "6.9vw", fontWeight: 900, color: "#DAA520", lineHeight: 1, textShadow: "0 0 3vw rgba(201,168,76,0.5)" }}>1.2M</div>
              <div style={{ fontSize: "2.24vw", color: "#0d1830", marginTop: "0.5vh" }}>مؤسسة صغيرة ومتوسطة</div>
              <div style={{ fontSize: "1.89vw", color: "#DAA520", fontWeight: 700, marginTop: "0.5vh" }}>+97% من النسيج الاقتصادي</div>
            </div>
            <div className="anim-morph-in delay-5" style={{ background: "rgba(240,244,252,0.80)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.35)", borderRadius: "1vw", padding: "1.8vh 2vw" }}>
              <div style={{ fontSize: "1.89vw", color: "#DAA520", fontWeight: 700, marginBottom: "0.5vh" }}>الأهمية الاستراتيجية</div>
