    ...
    <div className={`relative w-screen h-screen overflow-hidden ${cls}`} style={{ background: "#ffffff", fontFamily: "Cairo, sans-serif", direction: "rtl" }}>
      ...
      <div className="relative z-10 flex h-full">
        ...
        <div style={{ width: "45%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "7vh 3vw 7vh 8vw" }}>
          ...
          <h2 className="anim-clip-rtl delay-2" style={{ fontSize: "4vw", fontWeight: 900, color: "#0d1830", margin: 0, lineHeight: 1.15 }}>المقاولاتية</h2>
        ...
        <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "7vh 6vw 7vh 3vw", gap: "1.5vh" }}>
          <div className="anim-fade delay-2" style={{ fontSize: "1.4vw", color: "#4a5a78", fontWeight: 600, marginBottom: "0.5vh" }}>المسار المقاولاتي</div>

          <div className="anim-perspective delay-3" style={{ display: "flex", gap: "1.5vw", alignItems: "center", background: "rgba(240,244,252,0.88)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "1vw", padding: "1.5vh 2vw" }}>
          ...
          <div className="anim-perspective delay-4" style={{ display: "flex", gap: "1.5vw", alignItems: "center", background: "rgba(240,244,252,0.88)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "1vw", padding: "1.5vh 2vw" }}>
          ...
          <div className="anim-perspective delay-5" style={{ display: "flex", gap: "1.5vw", alignItems: "center", background: "rgba(201,168,76,0.18)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.35)", borderRadius: "1vw", padding: "1.5vh 2vw", boxShadow: "0 0 2vw rgba(201,168,76,0.07)" }}>
          ...
          <div className="anim-perspective delay-6" style={{ display: "flex", gap: "1.5vw", alignItems: "center", background: "rgba(240,244,252,0.88)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "1vw", padding: "1.5vh 2vw" }}>
