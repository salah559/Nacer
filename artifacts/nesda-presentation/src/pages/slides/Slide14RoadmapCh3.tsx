          ...
          <div className="anim-card-morph delay-6" style={{ marginTop: "3.5vh", background: "rgba(201,168,76,0.07)", border: "1px solid rgba(201,168,76,0.3)", borderRadius: "1vw", padding: "1.2vh 1.5vw", alignSelf: "flex-start" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.8vw" }}>
              <div style={{ flex: 1, height: "0.4vh", background: "rgba(201,168,76,0.15)", borderRadius: "1vw", overflow: "hidden" }}>
                <div style={{ width: "60%", height: "100%", background: "linear-gradient(90deg, #E8B923, #f0d080)", borderRadius: "1vw", animation: "lineGrow 0.8s ease 0.6s both" }} />
              </div>
              <span style={{ fontSize: "1.59vw", fontWeight: 700, color: "#DAA520" }}>60%</span>
            </div>
          </div>
        </div>
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "2vw", position: "relative" }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
                      ...
                      {isActive && (
                        <div style={{ marginRight: "auto", marginLeft: "0", background: "#E8B923", borderRadius: "2vw", padding: "0.3vh 0.9vw", fontSize: "1.35vw", fontWeight: 700, color: "#ffffff", whiteSpace: "nowrap", animation: "fadeIn 0.4s ease 1.7s both" }}>الفصل الحالي</div>
                      )}
                    </div>
                  </div>
                </div>
