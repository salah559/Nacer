...
const NODE_DELAYS = [0.25, 0.35, 1.25, 1.40, 1.52];
const CARD_DELAYS = [0.30, 0.40, 1.32, 1.47, 1.58];
...
<div className="gold-bar-top" />
      ...
      <div className="particle particle-2" style={{ top: "14%", right: "22%", width: "0.4vw", height: "0.4vw", background: "rgba(201,168,76,0.4)", boxShadow: "0 0 1vw rgba(201,168,76,0.5)" }} />
      <div className="particle particle-5" style={{ top: "72%", right: "32%", width: "0.3vw", height: "0.3vw", background: "rgba(201,168,76,0.3)" }} />
      ...
      <div className="relative z-10 flex h-full">
        ...
        <div style={{ width: "36%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "7vh 3vw 7vh 7vw", borderLeft: "1px solid rgba(201,168,76,0.15)" }}>
          ...
          <h2 className="anim-clip-rtl delay-3" style={{ fontSize: "3.6vw", fontWeight: 900, margin: 0, lineHeight: 1.15 }}>
            <span className="gold-shimmer" style={{ display: "inline-block" }}>الفصل الثاني</span>
          </h2>
          ...
          <div className="anim-perspective delay-6" style={{ marginTop: "3.5vh", background: "rgba(201,168,76,0.07)", border: "1px solid rgba(201,168,76,0.3)", borderRadius: "1vw", padding: "1.2vh 1.5vw", alignSelf: "flex-start" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.8vw" }}>
              <div style={{ flex: 1, height: "0.4vh", background: "rgba(201,168,76,0.15)", borderRadius: "1vw", overflow: "hidden" }}>
                <div style={{ width: "40%", height: "100%", background: "linear-gradient(90deg, #c9a84c, #f0d080)", borderRadius: "1vw", animation: "lineGrow 0.8s ease 0.6s both" }} />
              </div>
              <span style={{ fontSize: "1.1vw", fontWeight: 700, color: "#c9a84c" }}>40%</span>
            </div>
          </div>
        </div>
                ...
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "2vw", position: "relative" }}>
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
                      ...
                      {isActive && (
                        <div style={{ marginRight: "auto", marginLeft: "0", background: "#c9a84c", borderRadius: "2vw", padding: "0.3vh 0.9vw", fontSize: "0.9vw", fontWeight: 700, color: "#ffffff", whiteSpace: "nowrap", animation: "fadeIn 0.4s ease 1.6s both" }}>الفصل الحالي</div>
                      )}
                    </div>
                  </div>
                </div>
