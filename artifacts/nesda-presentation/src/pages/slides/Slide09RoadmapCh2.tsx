...
const delays = ["delay-2","delay-2","delay-3","delay-4","delay-5"];
...
export default function Slide09RoadmapCh2() {
  return (
    <div className={`relative w-screen h-screen overflow-hidden ${cls}`} style={{ background: "#050a18", fontFamily: "Cairo, sans-serif", direction: "rtl" }}>
      ...
      <div className="particle particle-2" style={{ top: "15%", right: "12%", width: "0.4vw", height: "0.4vw", background: "rgba(201,168,76,0.5)", borderRadius: "50%", boxShadow: "0 0 1vw rgba(201,168,76,0.7)" }} />
      <div className="particle particle-5" style={{ top: "70%", right: "20%", width: "0.3vw", height: "0.3vw", background: "rgba(240,208,128,0.4)", borderRadius: "50%" }} />
      ...
      <div className="relative z-10 flex h-full">
        <div style={{ width: "38%", display: "flex", flexDirection: "column", justifyContent: "center", padding: "7vh 3vw 7vh 8vw" }}>
          ...
          <h2 className="anim-clip-rtl delay-3" style={{ fontSize: "3.8vw", fontWeight: 900, margin: 0, lineHeight: 1.15 }}><span className="gold-shimmer" style={{ display: "inline-block" }}>للفصل الثاني</span></h2>
          ...
          <div className="anim-fade delay-5" style={{ fontSize: "1.5vw", color: "#7a90b5", lineHeight: 1.5 }}>المقاولاتية والوكالة الوطنية NESDA</div>
        </div>
