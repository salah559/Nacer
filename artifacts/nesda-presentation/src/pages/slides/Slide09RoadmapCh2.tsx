            ...
            {chapters.map((ch, i) => {
              ...
              return (
                <div key={i} style={{ display: "flex", alignItems: "center", gap: "2vw", position: "relative" }}>
                  ...
                  {isActive && (
                    <>
                      <div style={{ position: "absolute", right: "-3.5vw", top: "50%", transform: "translateY(-50%) translateX(50%)", width: "1.8vw", height: "1.8vw", borderRadius: "50%", border: "2px solid rgba(21,101,192,0.7)", animation: "activeRing 1.6s ease-out 1.4s infinite" }} />
                      <div style={{ position: "absolute", right: "-3.5vw", top: "50%", transform: "translateY(-50%) translateX(50%)", width: "1.8vw", height: "1.8vw", borderRadius: "50%", border: "2px solid rgba(21,101,192,0.4)", animation: "activeRing2 1.6s ease-out 1.9s infinite" }} />
                    </>
                  )}
                  ...
                  <div style={{
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "1.2vw" }}>
                      ...
                      {isActive && (
                        <div style={{ marginRight: "auto", marginLeft: "0", background: "#1565C0", borderRadius: "2vw", padding: "0.3vh 0.9vw", fontSize: "1.35vw", fontWeight: 700, color: "#ffffff", whiteSpace: "nowrap", animation: "fadeIn 0.4s ease 1.6s both" }}>الفصل الحالي</div>
                      )}
                    </div>
                  </div>
                </div>
