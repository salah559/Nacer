...
export default function Slide17Conclusions() {
  return (
    <div className={`relative w-screen h-screen overflow-hidden ${cls}`} style={{ background: "#050a18", fontFamily: "Cairo, sans-serif", direction: "rtl" }}>
      <div className="absolute inset-0" style={{ background: "radial-gradient(ellipse 80% 70% at 50% 50%, rgba(10,20,50,0.9) 0%, transparent 75%)" }} />
      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "6vh 8vw" }}>
        <div style={{ marginBottom: "3vh" }}>
          ...
          <h2 className="anim-clip-rtl delay-2" style={{ fontSize: "4vw", fontWeight: 900, color: "#f0f4ff", margin: 0 }}>النتائج والتوصيات</h2>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2.5vw", flex: 1, alignItems: "center" }}>
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5vh" }}>
            ...
            <div className="anim-perspective delay-3" style={{ background: "rgba(201,168,76,0.07)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: "1vw", padding: "1.5vh 2vw", display: "flex", gap: "1vw", alignItems: "flex-start" }}>
              ...
              <div style={{ fontSize: "1.45vw", color: "#f0f4ff", lineHeight: 1.5 }}>NESDA تثبت صحة الفرضية الأولى: تمويل فعلي للمؤسسات</div>
            </div>
            <div className="anim-perspective delay-4" style={{ background: "rgba(201,168,76,0.07)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: "1vw", padding: "1.5vh 2vw", display: "flex", gap: "1vw", alignItems: "flex-start" }}>
              <div style={{ fontSize: "2vw", flexShrink: 0, lineHeight: 1 }}>✅</div>
              <div style={{ fontSize: "1.45vw", color: "#f0f4ff", lineHeight: 1.5 }}>التمويل يُسهم في خلق مناصب الشغل (+3 منصب/مشروع)</div>
            </div>
            <div className="anim-perspective delay-5" style={{ background: "rgba(201,168,76,0.07)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.25)", borderRadius: "1vw", padding: "1.5vh 2vw", display: "flex", gap: "1vw", alignItems: "flex-start" }}>
              <div style={{ fontSize: "2vw", flexShrink: 0, lineHeight: 1 }}>⚡</div>
              <div style={{ fontSize: "1.45vw", color: "#f0f4ff", lineHeight: 1.5 }}>وهران نموذج وطني ناجح رغم التحديات الميدانية</div>
            </div>
          </div>

          <div style={{ display: "flex", flexDirection: "column", gap: "1.5vh" }}>
            <div className="anim-fade delay-2" style={{ fontSize: "1.4vw", color: "#c9a84c", fontWeight: 700, marginBottom: "0.5vh" }}>التوصيات</div>
            <div className="anim-perspective delay-4" style={{ background: "rgba(14,22,44,0.6)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "1vw", padding: "1.5vh 2vw" }}>
              <div style={{ fontSize: "1.45vw", color: "#f0f4ff", lineHeight: 1.5 }}>📌 تعزيز متابعة المشاريع بعد الإطلاق</div>
            </div>
            <div className="anim-perspective delay-5" style={{ background: "rgba(14,22,44,0.6)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "1vw", padding: "1.5vh 2vw" }}>
              <div style={{ fontSize: "1.45vw", color: "#f0f4ff", lineHeight: 1.5 }}>📌 رقمنة الإجراءات وتقليص الأعباء الإدارية</div>
            </div>
            <div className="anim-perspective delay-6" style={{ background: "rgba(14,22,44,0.6)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "1vw", padding: "1.5vh 2vw" }}>
              <div style={{ fontSize: "1.45vw", color: "#f0f4ff", lineHeight: 1.5 }}>📌 تعميق التنسيق مع المنظومة البنكية</div>
            </div>
            <div className="anim-perspective delay-7" style={{ background: "rgba(14,22,44,0.6)", backdropFilter: "blur(12px)", WebkitBackdropFilter: "blur(12px)", border: "1px solid rgba(201,168,76,0.15)", borderRadius: "1vw", padding: "1.5vh 2vw" }}>
              <div style={{ fontSize: "1.45vw", color: "#f0f4ff", lineHeight: 1.5 }}>📌 توسيع دور مراكز CDE في الولايات الداخلية</div>
            </div>
          </div>
        </div>
      </div>
