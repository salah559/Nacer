      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "7vh 9vw 6vh 5vw" }}>
        ...
        <div className="anim-morph-in delay-1" style={{ display: "flex", alignItems: "center", gap: "1.2vw", marginBottom: "1.5vh" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "0.6vw" }}>
            <div style={{ width: "2.5vw", height: "0.25vh", background: "linear-gradient(90deg, transparent, #1565C0)" }} />
            <div style={{ width: "0.5vw", height: "0.5vw", borderRadius: "50%", background: "#1565C0", boxShadow: "0 0 0.8vw rgba(21,101,192,0.9)" }} />
          </div>
          <span style={{ fontSize: "1.89vw", color: "#1565C0", letterSpacing: "0.14em", fontWeight: 700, textTransform: "uppercase" }}>مذكرة نهاية التخرج · ليسانس ل.م.د · 2025/2026</span>
          <div style={{ display: "flex", alignItems: "center", gap: "0.6vw" }}>
            <div style={{ width: "0.5vw", height: "0.5vw", borderRadius: "50%", background: "#1565C0", boxShadow: "0 0 0.8vw rgba(21,101,192,0.9)" }} />
            <div style={{ width: "2.5vw", height: "0.25vh", background: "linear-gradient(270deg, transparent, #1565C0)" }} />
          </div>
        </div>
        ...
        {/* Decorative divider */}
        <div className="anim-line-draw delay-2" style={{ width: "18vw", height: "0.25vh", marginBottom: "3.5vh", background: "linear-gradient(90deg, #1565C0, transparent)" }} />
        ...
        <div className="anim-morph-in delay-4" style={{ display: "flex", alignItems: "center", gap: "1.2vw", marginBottom: "4vh" }}>
          <div style={{ width: "0.4vw", height: "4vh", background: "linear-gradient(180deg, transparent, #1565C0, transparent)", borderRadius: "2px" }} />
          <div>
            <div style={{ fontSize: "2.56vw", color: "#2a4060", fontWeight: 400, lineHeight: 1.4 }}>في إطار الوكالة الوطنية لدعم وتنمية المقاولاتية</div>
            <div style={{ fontSize: "2.86vw", color: "#1565C0", fontWeight: 800, letterSpacing: "0.08em" }}>NESDA — فرع وهران</div>
          </div>
        </div>
        ...
        <div className="anim-card-morph delay-5" style={{ background: "rgba(240,244,252,0.92)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", border: "1px solid rgba(21,101,192,0.2)", borderRadius: "1.5vw", padding: "2.2vh 3vw", display: "flex", justifyContent: "space-between", alignItems: "center", boxShadow: "0 0.5vh 4vw rgba(0,0,0,0.5), inset 0 1px 0 rgba(21,101,192,0.28)" }}>
          <div>
          ...
          <div className="anim-morph-in delay-6" style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.5vh" }}>
            <div style={{ width: "0.3vw", height: "5vh", background: "linear-gradient(180deg, transparent, rgba(21,101,192,0.5), transparent)" }} />
            <div style={{ background: "rgba(21,101,192,0.35)", border: "1px solid rgba(21,101,192,0.4)", borderRadius: "50%", width: "6vw", height: "6vw", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", boxShadow: "0 0 2.5vw rgba(21,101,192,0.2)" }}>
              <div style={{ fontSize: "1.59vw", color: "#1565C0", fontWeight: 700, lineHeight: 1.2, textAlign: "center" }}>الدفعة<br />16</div>
            </div>
            <div style={{ fontSize: "1.59vw", color: "#1565C0", fontWeight: 600 }}>ماي 2026</div>
            <div style={{ width: "0.3vw", height: "5vh", background: "linear-gradient(180deg, transparent, rgba(21,101,192,0.5), transparent)" }} />
          </div>
          <div style={{ textAlign: "left" }}>
            <div style={{ fontSize: "1.74vw", color: "#4a5a78", marginBottom: "0.6vh", letterSpacing: "0.06em" }}>تحت إشراف</div>
            <div style={{ fontSize: "2.7vw", color: "#1565C0", fontWeight: 700 }}>الأستاذ الدكتور</div>
