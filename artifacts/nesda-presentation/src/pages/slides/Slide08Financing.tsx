    ...
    <div className={`relative w-screen h-screen overflow-hidden ${cls}`} style={{ background: "#ffffff", fontFamily: "Cairo, sans-serif", direction: "rtl" }}>
      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "6vh 8vw" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "2.5vw", flex: 1, alignItems: "center" }}>
          ...
          {/* Right — solutions */}
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5vh" }}>
            <div className="anim-smooth-fade delay-2" style={{ fontSize: "1.96vw", color: "#1565C0", fontWeight: 600, marginBottom: "0.5vh" }}>مصادر التمويل البديلة</div>
            <div className="anim-reveal-up delay-3" style={{ background: "rgba(21,101,192,0.07)", border: "1px solid rgba(21,101,192,0.2)", borderRadius: "0.8vw", padding: "1.5vh 2vw", display: "flex", gap: "1.2vw", alignItems: "center" }}>
            ...
            <div className="anim-reveal-up delay-4" style={{ background: "rgba(21,101,192,0.07)", border: "1px solid rgba(21,101,192,0.2)", borderRadius: "0.8vw", padding: "1.5vh 2vw", display: "flex", gap: "1.2vw", alignItems: "center" }}>
              <div style={{ width: "0.5vw", height: "0.5vw", borderRadius: "50%", background: "#1565C0", flexShrink: 0, boxShadow: "0 0 0.8vw rgba(21,101,192,0.6)" }} />
              <div style={{ fontSize: "2.1vw", color: "#0d1830" }}>رأس المال المخاطر والمشاركة</div>
            </div>
            <div className="anim-reveal-up delay-5" style={{ background: "rgba(21,101,192,0.35)", border: "1px solid rgba(21,101,192,0.4)", borderRadius: "0.8vw", padding: "1.5vh 2vw", display: "flex", gap: "1.2vw", alignItems: "center", boxShadow: "0 0 2vw rgba(21,101,192,0.18)" }}>
            ...
            <div className="anim-reveal-up delay-6" style={{ background: "rgba(21,101,192,0.07)", border: "1px solid rgba(21,101,192,0.2)", borderRadius: "0.8vw", padding: "1.5vh 2vw", display: "flex", gap: "1.2vw", alignItems: "center" }}>
              <div style={{ width: "0.5vw", height: "0.5vw", borderRadius: "50%", background: "#1565C0", flexShrink: 0, boxShadow: "0 0 0.8vw rgba(21,101,192,0.6)" }} />
