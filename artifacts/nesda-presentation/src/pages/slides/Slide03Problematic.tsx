...
<div className="gold-accent-top" /><div className="gold-accent-bottom" />
      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "7vh 8vw" }}>
        <div style={{ marginBottom: "3.5vh" }}>
          <div className="anim-smooth-fade delay-1" style={{ fontSize: "1.74vw", color: "#1565C0", letterSpacing: "0.18em", fontWeight: 700, marginBottom: "1vh", textTransform: "uppercase" }}>المقدمة العامة</div>
        ...
        <div className="anim-card-morph delay-3" style={{ background: "rgba(240,244,252,0.95)", backdropFilter: "blur(20px)", WebkitBackdropFilter: "blur(20px)", border: "1px solid rgba(21,101,192,0.3)", borderRadius: "1.5vw", padding: "3vh 3.5vw", marginBottom: "3vh", position: "relative", overflow: "hidden", boxShadow: "0 0 4vw rgba(21,101,192,0.18), inset 0 1px 0 rgba(21,101,192,0.35)" }}>
          ...
          <div style={{ fontSize: "1.89vw", color: "#1565C0", fontWeight: 600, marginBottom: "1vh", letterSpacing: "0.1em" }}>السؤال المحوري</div>
          <div style={{ fontSize: "2.73vw", color: "#0d1830", fontWeight: 700, lineHeight: 1.6, fontStyle: "italic" }}>
            ...
            <br /><span style={{ color: "#1565C0" }}>لدعم وتنمية المقاولاتية</span> في تمويل المؤسسات الصغيرة والمتوسطة؟"
          </div>
        </div>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "1.5vw" }}>
          <div className="anim-morph-in delay-4" style={{ background: "rgba(240,244,252,0.80)", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", border: "1px solid rgba(21,101,192,0.35)", borderRadius: "1vw", padding: "2vh 1.8vw", position: "relative" }}>
            ...
            <div style={{ fontSize: "3.25vw", fontWeight: 900, color: "rgba(21,101,192,0.18)", marginBottom: "0.5vh" }}>01</div>
          ...
          <div className="anim-morph-in delay-5" style={{ background: "rgba(240,244,252,0.80)", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", border: "1px solid rgba(21,101,192,0.35)", borderRadius: "1vw", padding: "2vh 1.8vw", position: "relative" }}>
            <div style={{ position: "absolute", top: 0, left: "25%", right: "25%", height: "0.2vh", background: "linear-gradient(90deg, transparent, rgba(21,101,192,0.6), transparent)" }} />
            <div style={{ fontSize: "3.25vw", fontWeight: 900, color: "rgba(21,101,192,0.18)", marginBottom: "0.5vh" }}>02</div>
            <div style={{ fontSize: "2.03vw", color: "#0d1830", lineHeight: 1.5, fontWeight: 600 }}>كيف يتم تمويل PME قبل تدخل NESDA؟</div>
          </div>
          <div className="anim-morph-in delay-6" style={{ background: "rgba(240,244,252,0.80)", backdropFilter: "blur(10px)", WebkitBackdropFilter: "blur(10px)", border: "1px solid rgba(21,101,192,0.35)", borderRadius: "1vw", padding: "2vh 1.8vw", position: "relative" }}>
            <div style={{ position: "absolute", top: 0, left: "25%", right: "25%", height: "0.2vh", background: "linear-gradient(90deg, transparent, rgba(21,101,192,0.6), transparent)" }} />
            <div style={{ fontSize: "3.25vw", fontWeight: 900, color: "rgba(21,101,192,0.18)", marginBottom: "0.5vh" }}>03</div>
