...
<div className="gold-accent-top" /><div className="gold-accent-bottom" />
      ...
      <div className="relative z-10 flex flex-col h-full" style={{ padding: "7vh 8vw" }}>
        <div style={{ marginBottom: "3.5vh" }}>
          <div className="anim-smooth-fade delay-1" style={{ fontSize: "1.2vw", color: "#8B6914", letterSpacing: "0.18em", fontWeight: 700, marginBottom: "1vh", textTransform: "uppercase" }}>المقدمة العامة</div>
          ...
          <div className="anim-line-draw delay-3" style={{ width: "12vw", height: "0.3vh", background: "linear-gradient(90deg, #c9a84c, #f0d080, transparent)" }} />
        </div>
